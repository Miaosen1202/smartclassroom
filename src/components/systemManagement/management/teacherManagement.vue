  ...
  <div class="management">
    ...
    <div>
      <el-table
        ...
        <el-table-column prop="userName" label="账号" min-width="30%"></el-table-column>
        ...
        <el-table-column prop="updateTime" label="更新" :formatter="formatter" min-width="40%">
      ...
      <el-dialog
        ...
        <div class="projectile" style="padding-left: 10%">
          <ul>
            <li>
              <sapn>老师编号：</sapn>
              <el-input v-model="input" size="small" placeholder="请输入老师编号" style="width: 60%"></el-input>
            </li>
            <li>
              <sapn>老师姓名：</sapn>
              <el-input v-model="input" size="small" placeholder="请输入老师姓名" style="width: 60%"></el-input>
            </li>
            <li>
              <sapn>个人邮箱：</sapn>
              <el-input v-model="input" size="small" placeholder="请输入个人邮箱" style="width: 60%"></el-input>
            </li>
            <li>
              <sapn>联系电话：</sapn>
              <el-input v-model="input" size="small" placeholder="请输入联系电话" style="width: 60%"></el-input>
            </li>
            <li>
